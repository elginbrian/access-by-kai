  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-80 bg-white p-6 shadow-2xl border-r border-gray-100 overflow-y-auto z-10">
      ...
      <nav className="space-y-2">
        ...
        <button className="w-full text-left px-4 py-3 rounded-xl hover:bg-gray-50 transition-all duration-200 transform hover:scale-[1.01] border border-gray-100" style={{ color: colors.base.darker }}>
          Ganti Kata Sandi
        </button>
        <button className="w-full text-left px-4 py-3 rounded-xl hover:bg-gray-50 transition-all duration-200 transform hover:scale-[1.01] border border-gray-100" style={{ color: colors.base.darker }}>
          Daftar Penumpang
        ...
        <button className="w-full text-left px-4 py-3 rounded-xl hover:bg-red-50 transition-all duration-200 transform hover:scale-[1.01] border border-gray-100" style={{ color: colors.red.normal }}>
          Keluar
        </button>
      </nav>
    </aside>
