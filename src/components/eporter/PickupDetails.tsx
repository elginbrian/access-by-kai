        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-500">Specify where to meet your porter</p>
                </div>
            </div>
            ...
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        >
                            <option value="" disabled>Select meeting point</option>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        placeholder="E.g., need porter to carry 2 suitcases, help with wheelchair, etc."
                        rows={4}
