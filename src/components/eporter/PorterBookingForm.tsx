...
const PorterBookingForm: React.FC<PorterBookingFormProps> = ({
    ticketId,
    onBack,
    onSubmit
}) => {
            ...
            <div className="flex flex-row w-full gap-4">
                ...
                <div className="flex-1">
                    <button
                        ...
                        disabled={!canSubmit}
                        className={`px-8 py-3 rounded-lg font-semibold transition-all w-full flex items-center justify-center gap-2 ${canSubmit
                            ? 'bg-gradient-to-b from-[#6b46c1] to-[#3b82f6] text-white hover:from-purple-700 hover:to-blue-700 transform hover:scale-101'
