    ...
    return (
        <div className="bg-gradient-to-br from-purple-600 to-blue-600 rounded-2xl shadow-lg p-8 text-center">
            ...
            <p className="text-white/90 text-sm mb-6">
                Our customer service is available<br />24/7
            </p>
            <button 
                onClick={onContactClick}
                className="bg-white text-purple-700 px-6 py-2.5 rounded-lg font-semibold text-sm hover:bg-gray-50 transition-colors"
            >
                Contact Support
            </button>
        </div>
