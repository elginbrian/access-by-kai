...
const TicketInfoCard: React.FC<TicketInfoCardProps> = ({ trainName, trainCode, trainClass, departureTime, departureStation, arrivalTime, arrivalStation, duration, travelClass, date, timeRange }) => {
  return (
