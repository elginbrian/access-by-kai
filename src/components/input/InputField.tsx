...
const InputField: React.FC<InputFieldProps> = ({ label, startIcon, endIcon, ...props }) => {
  return (
    <div style={{ position: 'relative', width: '100%' }}>
      ...
      >
        {/* Start Icon */}
        {startIcon && (
          <span style={{ color: colors.base.dark, display: 'flex', alignItems: 'center', marginRight: '8px' }}>
            {startIcon}
          </span>
        )}
        ...
        {/* End Icon */}
        {endIcon && (
          <span style={{ color: colors.base.dark, display: 'flex', alignItems: 'center', marginLeft: '8px' }}>
            {endIcon}
          </span>
        )}
      </div>
