...
const HeroSection: React.FC<HeroSectionProps> = ({ title, description, buttonText = "Pesan Sekarang", imageSrc = "/img_kai_logistic.png", imageAlt = "KAI Logistic", onButtonClick }) => {
