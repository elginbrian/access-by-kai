...
const JourneyDetails: React.FC<JourneyDetailsProps> = ({ trainName, trainCode, departureTime, departureStation, departureDate, arrivalTime, arrivalStation, arrivalDate }) => {
  return (
