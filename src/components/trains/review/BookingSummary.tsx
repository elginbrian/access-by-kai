    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm p-6 sticky top-6 h-fit">
            ...
            <div className="space-y-3 mb-6">
                <button 
                    onClick={onEditSeat}
                    className="w-full py-3 px-4 bg-[#eff6ff] border border-[#bfdbfe] text-blue-600 rounded-xl font-semibold hover:bg-blue-50 transition-colors flex items-center justify-between"
                >
