...
const CreditCardForm: React.FC<CreditCardFormProps> = ({
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Promo Code */}
            <div>
                <label className="block text-sm font-medium text-black mb-2 border-t border-gray-200 pt-4">
                    Kode Promo (Opsional)
                </label>
                <div className="flex gap-3">
                    ...
                    />
                    <button className="px-6 py-3 bg-gray-100 text-black font-semibold rounded-lg hover:bg-gray-200 transition-colors">
                        Terapkan
                    </button>
                </div>
            </div>
