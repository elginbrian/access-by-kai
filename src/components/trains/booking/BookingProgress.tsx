...
const BookingProgress: React.FC<BookingProgressProps> = ({
    ...
    const getStepIcon = (step: BookingStep, index: number) => {
        ...
        // Default icons based on common booking steps
                        ...
                        return (
                            <React.Fragment key={step.id}>
                                ...
                                >
                                    ...
                                    <div
                                        className={`px-5 py-3 rounded-full flex items-center gap-2 transition-all duration-300 ${isClickable ? 'hover:scale-105 cursor-pointer' : ''
                                            }`}
