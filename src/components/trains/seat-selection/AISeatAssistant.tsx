...
const AISeatAssistant: React.FC<AISeatAssistantProps> = ({ onSuggestionApply }) => {
    ...
    const [messages, setMessages] = useState<ChatMessage[]>([
        {
            id: '1',
            text: "Hi! I'm here to help you find the perfect seats. What are your preferences?",
            sender: 'ai',
            timestamp: new Date()
        },
        {
            id: '2',
            text: "I want window seats for both passengers",
            sender: 'user',
            timestamp: new Date()
        },
        {
            id: '3',
            text: "Perfect! I recommend seats 3A and 3C - both window seats are close together. Would you like me to select them?",
            sender: 'ai',
            timestamp: new Date()
        }
    ]);
        ...
        if (message.trim()) {
            ...
            setTimeout(() => {
                const aiResponse: ChatMessage = {
                    ...
                    text: "I understand your request. Let me find the best seats for you based on your preferences.",
                    sender: 'ai',
                    timestamp: new Date()
                };
        ...
        <div className="bg-white rounded-2xl p-6 border">
            ...
            <div className="space-y-2 mb-4 max-h-48 overflow-y-auto">
                {messages.map((msg) => (
                    <div
                        key={msg.id}
                        className={`text-xs p-2 rounded-lg ${msg.sender === 'ai'
                            ? 'bg-gray-100 mr-4'
                            : 'bg-blue-100 ml-4'
                            }`}
                    >
