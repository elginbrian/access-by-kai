...
const PassengerList: React.FC<PassengerListProps> = ({ passengers, onPassengerChange, onAutoAssign }) => {
  return (
    <div className="bg-white rounded-br-2xl p-6 border">
      ...
      {/* Auto-assign Button */}
      {onAutoAssign && (
        <button onClick={onAutoAssign} className="w-full mt-4 bg-gray-800 text-white py-3 px-4 rounded-lg text-sm font-medium flex items-center justify-center gap-2 hover:bg-gray-700 transition-colors">
