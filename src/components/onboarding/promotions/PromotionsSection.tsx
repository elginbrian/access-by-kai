...
const PromotionsSection: React.FC = () => {
    const promotions = [
        {
            title: '50% Off Executive Class',
            description: 'Get massive discounts for executive class tickets on selected routes',
            image: '/img_executive_class.png',
            buttonText: 'Book Now'
        },
        {
            title: 'Bundle Packages',
            description: 'Complete travel packages with accommodation and transportation',
