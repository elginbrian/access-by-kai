  ...
  const destinations = [
    {
      ...
      description: "Jelajahi kota metropolitan dengan atraksi modern dan budaya yang kaya",
    },
    {
      city: "Bandung",
      image: "/dummy_images.png",
      description: "Temukan Paris van Java dengan udara sejuk dan suasana kreatif",
    },
    {
      city: "Yogyakarta",
      image: "/dummy_images.png",
      description: "Rasakan jantung budaya Jawa dengan candi dan istana bersejarah",
    },
    {
      city: "Surabaya",
      image: "/dummy_images.png",
      description: "Kunjungi kota pahlawan dengan warisan industri dan kuliner yang lezat",
    },
  ];
        ...
        <div className="flex items-center mb-12 gap-10">
          <div className="flex flex-row items-center gap-8 flex-1">
            ...
            <div>
              ...
              <p className="text-lg text-black leading-relaxed">Jelajahi keindahan Indonesia dengan layanan kereta api yang nyaman. Temukan destinasi menarik dan nikmati perjalanan yang tak terlupakan.</p>
            </div>
          </div>
          ...
          <div className="overflow-x-auto pb-10 px-8 -mx-8 flex gap-6" style={{ scrollbarWidth: "none" }}>
            {destinations.map((destination, index) => (
              <div className="snap-center min-w-[300px]" key={index}>
                <DestinationCard city={destination.city} image={destination.image} description={destination.description} />
              </div>
            ))}
          </div>
        </div>
