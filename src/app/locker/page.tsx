...
const ShowLokPage = () => {
  ...
  const handleTicketSelect = (ticketId: string) => {
    // Navigate to display page to show facilities for this ticket's stations
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm font-medium">
                    Pembayaran berhasil! Booking ShowLok Anda telah dikonfirmasi.
                  </p>
                </div>
              </div>
            </div>
