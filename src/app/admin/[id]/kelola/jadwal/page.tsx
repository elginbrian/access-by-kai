...
const sampleRows: JadwalRow[] = [
  { id: 'RRV001', namaKereta: 'Argo Jaya', rute: 'A-gantl Senen', jamBerangkat: '08:00', jamTiba: '20:30', penumpangHariIni: 'AC lebih dingin, wifi stabil', okupansiPercent: 75 },
  { id: 'RRV002', namaKereta: 'Sila Dharr', rute: 'Jakarta - JKT VIP', jamBerangkat: '09:15', jamTiba: '17:45', penumpangHariIni: 'Pelayanan sangat baik, tepat waktu...', okupansiPercent: 85 },
  { id: 'RRV003', namaKereta: 'Argo Jaya', rute: 'Gajayana - MLGS BT', jamBerangkat: '07:30', jamTiba: '15:00', penumpangHariIni: 'Kursi nyaman, bersih dan rapi', okupansiPercent: 60 },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="col-span-8 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              <ChartMultiBar categories={["Sen", "Sel", "Rab", "Kam", "Jum", "Sab", "Min"]} series={barSeries} height={240} width={420} />
            </div>
          </div>
          ...
          <TableKelola
            ...
            description="Menampilkan 1-12 dari 347 penumpang"
            data={sampleRows}
            columns={columns}
            perPage={3}
