                    ...
                    <div className="flex items-center gap-6 mb-12">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    <div className="text-lg font-semibold text-gray-800 mb-1">Package #KAI123456789</div>
                    ...
                    <div className="relative">
                        ...
                        <div className="flex items-start pb-12">
                            ...
                            <div className="ml-6 flex-1">
                                <h3 className="text-lg font-semibold text-gray-900 mb-1">Package Picked Up</h3>
                                <p className="text-gray-600">Jakarta Depot - Oct 15, 2024 10:30 AM</p>
                            </div>
                            {/* Vertical line */}
                        ...
                        <div className="flex items-start pb-12">
                            ...
                            <div className="ml-6 flex-1">
                                <h3 className="text-lg font-semibold text-gray-900 mb-1">In Transit</h3>
                                <p className="text-gray-600">Currently at Cirebon Hub - Oct 15, 2024 6:45 PM</p>
                            </div>
                            {/* Vertical line */}
                        ...
                        <div className="flex items-start">
                            ...
                            <div className="ml-6 flex-1">
                                <h3 className="text-lg font-semibold text-gray-500 mb-1">Out for Delivery</h3>
                                <p className="text-gray-500">Expected Oct 16, 2024</p>
                            </div>
                        </div>
                    </div>
                </div>
